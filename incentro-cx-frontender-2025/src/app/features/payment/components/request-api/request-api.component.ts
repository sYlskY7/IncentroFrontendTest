...
@Component({
  ...
  template: `
    <div
      class="bg-white rounded-card shadow-card p-8 w-full max-w-md border border-gray-200"
    >
      <h3 class="text-2xl font-extrabold text-black mb-8">
      ...
      <button
        type="button"
        (click)="onSearch()"
        class="w-full py-4 rounded-full bg-[#6366F1] text-white font-extrabold text-lg"
      >
        Add a new book
      </button>
